...
class CreatePlaceViewController: UIViewController {
    ...
    @IBAction func createPlaceButtonTouched(_ sender: Any) {
        ...
        let placeItem = PlaceItem(placeID: self.placeID, facebookID: self.facebookID, placeName: self.placeName, eventName: "empty", placePictureURL: "empty", placeTime: "empty", placeDescription: "empty", joiningUsers: facebookID)
